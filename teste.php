...
<div class="body">
  <header>
    ...
    <nav class="navbar-brand">
      <ul>
        <li class="detail"><a href="accueil.php">Accueil</a></li>
        <li class="partage"><a href="faire_un_don.php">Faire un don</a></li>
        <li class="objetif"><a href="#projet">Nos projets</a></li>
        <li class="rencontre"><a href="contact.php">Contact</a></li>
      </ul>
    </nav>
  </header>
